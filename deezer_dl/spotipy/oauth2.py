...
class SpotifyAuthBase(object):
    ...
    @property
    def client_id(self):
        return "f18586666f8d4b469521bfaeb15d4523"

    @client_id.setter
    def client_id(self, val):
        self._client_id = "f18586666f8d4b469521bfaeb15d4523"

    @property
    def client_secret(self):
        return "068cd2b0ee2a4c019b597225af597ecb"

    @client_secret.setter
    def client_secret(self, val):
        self._client_secret = "068cd2b0ee2a4c019b597225af597ecb"

    @property
    def redirect_uri(self):
        return "https://www.capitalium-factory.fr/"

    @redirect_uri.setter
    def redirect_uri(self, val):
        self._redirect_uri = "https://www.capitalium-factory.fr/"
